...
/**
 * Pricing (design W-P, FOUNDER-SIGNED 2026-07-12). 🟥 £49 flat per boat, everything included - no tiers,
    ...
    <div className="pt-24 md:pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          {FOUNDING_MODE ? (
            <>
              {/* W6 — the founding offer is the star; the £49 stays as the launch anchor below it. */}
              <div className="mx-auto max-w-2xl rounded-2xl border border-accent-cyan/30 bg-surface-1 p-6 md:p-8">
                ...
                <ul className="mt-5 text-sm text-text-secondary text-left max-w-md mx-auto space-y-2">
                  <li className="flex items-start gap-2"><Check className="w-4 h-4 mt-0.5 shrink-0 text-status-success" /> A permanent early-adopter discount - always below our public price, on the first boat you onboard.</li>
              ...
              <p className="mt-8 text-2xl md:text-3xl font-bold text-text-primary">£49 a month per boat at launch.</p>
            ...
            <>
              <h1 className="text-3xl md:text-5xl font-bold text-text-primary">£49 a month per boat.</h1>
        ...
        <div className="mt-10 rounded-2xl border border-brand-primary/30 bg-surface-1 p-6 md:p-8">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <div>
              <p className="text-4xl font-bold text-text-primary">£49<span className="text-lg font-medium text-text-muted"> / boat / month</span></p>
              {/* W2 anchor "Less than £1 a day" REMOVED at £49 (£49/30 ≈ £1.63, no longer sub-£1). Founder to choose any replacement value line. */}
              {FOUNDING_MODE
                ? <p className="mt-1 text-sm text-text-secondary">Founding Skippers: free to test, then a permanent founder’s discount below our public price, on your first boat.</p>
        ...
        {/* What it produces */}
        <div className="mt-12">
          <h2 className="text-xl md:text-2xl font-bold text-text-primary text-center">What your £49 produces</h2>
