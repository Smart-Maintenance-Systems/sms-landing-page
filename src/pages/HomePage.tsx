    ...
    <div className="pt-16 md:pt-20">
        ...
        <section className="relative border-t border-border-subtle py-16 md:py-24">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="rounded-2xl border border-accent-cyan/25 bg-surface-1 p-6 md:p-8">
              ...
              <p className="mt-3 text-text-secondary">Free to test, then founder pricing that stays below our public rate, on your first boat. Ten boats join as founding skippers, use it for real, and shape what it becomes.</p>
      ...
      <section className="relative border-t border-border-subtle py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-sm text-text-muted">{FOUNDING_MODE ? 'Founding Skippers: free while we finish it, then a permanent founder’s discount below our public price, on your first boat · 10 boats.' : '14-day free trial · no card required.'}</p>
